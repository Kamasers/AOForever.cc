...
On Error GoTo Errhandler
        ...
        With UserList(UserIndex)
            ...
            If MiNPC.flags.ExpCount > 0 Then
                If .PartyIndex > 0 Then
                    Call mod_Party.GanaExperiencia(MiNPC.flags.ExpCount, UserIndex) 'MiNPC.flags.ExpCount, MiNPC.Pos.map, MiNPC.Pos.X, MiNPC.Pos.Y)
                Else
    ...
    If MiNPC.MaestroUser = 0 Then
       ...
       ' Call NPCTirarOro(MiNPC)
        ...
        Call NPC_TIRAR_ITEMS(MiNPC, IsPretoriano, UserIndex)
        'ReSpawn o no
