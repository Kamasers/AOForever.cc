   ...
   ' Acepto el otro?
    ...
    For OfferSlot = 1 To MAX_OFFER_SLOTS + 1
        ...
        With UserList(UserIndex)
            ' Le pasa el oro
            If OfferSlot = GOLD_OFFER_SLOT Then
                If .Stats.GLD >= .ComUsu.goldAmount Then
            ...
            ElseIf .ComUsu.Objeto(OfferSlot) > 0 Then
                ...
                If TieneObjetos(TradingObj.ObjIndex, TradingObj.Amount, UserIndex) = True Then
        ...
        With UserList(OtroUserIndex)
            ...
            ElseIf .ComUsu.Objeto(OfferSlot) > 0 Then
                ...
                If TieneObjetos(TradingObj.ObjIndex, TradingObj.Amount, OtroUserIndex) Then
