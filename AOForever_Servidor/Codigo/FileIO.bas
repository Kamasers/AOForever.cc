...
For Object = 1 To NumObjDatas
    ...
    'ObjData(Object).QuitaEnergia = val(Leer.GetValue("OBJ" & Object, "Sta"))
...
With UserList(UserIndex)
    With .Stats
        ...
        .Diam = CLng(UserFile.GetValue("STATS", "DIAM"))
...
'***************************************************
    ...
    ExpMulti = val(GetVar(IniPath & "Server.ini", "INIT", "Exp"))
    OroMulti = val(GetVar(IniPath & "Server.ini", "INIT", "Oro"))
    ...
    IntervaloUserPuedeAtacar = 0 ''val(GetVar(IniPath & "Server.ini", "INTERVALOS", "IntervaloUserPuedeAtacar"))
...
With UserList(UserIndex)
    ...
    Call WriteVar(UserFile, "LOTERIA", "id_Loteria", .userLoteria.id_Loteria)
    Call WriteVar(UserFile, "LOTERIA", "numApostado", .userLoteria.numApostado)
    Call WriteVar(UserFile, "LOTERIA", "Apuesta", .userLoteria.vApuesta)
    With .userLoteria
        .id_Loteria = 0
        .numApostado = 0
        .vApuesta = 0
    ...
    Call WriteVar(UserFile, "FLAGS", "ExClan", CStr(.flags.ExClan))
    ...
    Call WriteVar(UserFile, "STATS", "DIAM", CStr(.Stats.Diam))
    ...
    Call WriteVar(UserFile, "Inventory", "AnilloSlot2", CStr(.Invent.AnilloEqpSlot2))
