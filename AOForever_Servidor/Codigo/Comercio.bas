...
Public Sub Comercio(ByVal Modo As eModoComercio, ByVal UserIndex As Integer, ByVal NpcIndex As Integer, ByVal Slot As Integer, ByVal Cantidad As Integer, Optional ByVal toSlot As Byte = 0)
'*************************************************
...
'*************************************************
    ...
    Call EnviarNpcInv(UserIndex, NpcIndex)
    Call WriteTradeOK(UserIndex)
