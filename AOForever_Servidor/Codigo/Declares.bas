...
Public Const ANILLOMAGICO As Integer = 1050
...
Private Type tUserDeath
    EnDeath As Boolean
    lastPos As WorldPos 'Para devolverlo a su posicion anterior
    SecondsBack As Integer
End Type

Private Type tUserHungerGames
    HungerGamers As Boolean
    lastPos As WorldPos
    SecondsBack As Integer
End Type
...
Public Type UserFlags
    Puntos As Integer
    ExClan As Integer 'Disolvió el clan
...
Private Type tMandoReto
    tIndex As Integer
    Oro As Long
    Items As Boolean
    Pociones As Integer
    Personaje As Boolean
    AIM As Boolean
End Type

Public Type tUserRetos
    EnReto As Boolean
    Arena As Byte
    MandoReto As tMandoReto
    lastPos As WorldPos
    TiempoRegresa As Byte
    Plantes As Boolean
    Escudos_Cascos As Boolean
End Type

'Tipo de los Usuarios

Public Type tEventAim
    ID_Array As Byte
End Type

Private Type tFreeze
    ID_Team_Array As Byte
    ID_User_Array As Byte
    Freezing As Boolean
End Type

Public Type User
    Captura As tUserCapture
    EnEvento As Boolean
    Freeze As tFreeze
    EventAim As tEventAim
    rank As tDatosRanking
    userLoteria As tUserLoteria
    'reto2Data As userStruct
    UserDeath As tUserDeath
    HungerGames As tUserHungerGames
    ACht As tAnticheat
    UserReto As tUserRetos
    PartySolicitud As Integer
    PartyIndex As Integer
    Torneo As tUserTorneo1
    LastMedit As Long
    Name As String
    ID As Long
    ...
    Stats As UserStats
    flags As UserFlags
    Retos3vs3 As User_Reto
    Retos2vs2 As User_Reto
