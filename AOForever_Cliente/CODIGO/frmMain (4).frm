...
Begin VB.Form frmMain 
   ...
   Begin VB.Label Label2 
      ...
      Width           =   1095
   End
   Begin VB.Label DiamLbl 
      BackStyle       =   0  'Transparent
      Caption         =   "Diamantes: 10"
      ForeColor       =   &H00FFFF80&
      Height          =   255
      Left            =   240
      TabIndex        =   37
...
Private Sub Form_Load()
    ...
    Cursor.AniFile = App.path & "\grafs\5555.ani"
    ...
    Me.Picture = LoadPicture(DirGraficos & "Main.bmp")
    ...
    Select Case KeyCode
        ...
        Case CustomKeys.BindedKey(eKeyType.mKeyTalkWithGuild)
            ...
            If (Not Comerciando) And (Not MirandoAsignarSkills) And _
              (Not frmMSG.Visible) And (Not MirandoForo) And (Not frmCantidad.Visible) Then
                SendCMSTXT.Visible = True
                SendCMSTXT.SetFocus
            End If
        
        Case CustomKeys.BindedKey(eKeyType.mKeyTakeScreenShot) 'f12
            Call ScreenCapture
        ...
        Case vbKeyF3
            If UserEstado = 1 Then
                ...
                Exit Sub
            End If
            Call WriteSolicitudParty
        
        Case CustomKeys.BindedKey(eKeyType.mKeyExitGame) 'vbKeyF4
        ...
        Case CustomKeys.BindedKey(eKeyType.mKeyWorkMacro) ' f8
            If UserEstado = 1 Then
                With FontTypes(FontTypeNames.FONTTYPE_INFO)
                    Call ShowConsoleMsg("¡¡Estás muerto!!", .red, .green, .blue, .bold, .italic)
                End With
            ...
            If ModoCombate Then
                With FontTypes(FontTypeNames.FONTTYPE_FIGHT)
                    Call ShowConsoleMsg("Debes desactivar el modo combate para trabajar", .red, .green, .blue, .bold, .italic)
                End With
                Exit Sub
            End If
        ...
        Case CustomKeys.BindedKey(eKeyType.mKeyShowOptions) 'vbKeyF9
...
Private Sub lblDD_Click()
    DragToUser = Not DragToUser
    If DragToUser = True Then
        lblDD.Caption = ""
    Else
        lblDD.Caption = "X"
    End If
...
Private Sub macrotrabajo_Timer()
    ...
    'If Inventario.OBJType(Inventario.SelectedItem) = eObjType.otWeapon Then
     If Not (frmCarp.Visible = True) Then Call UsarItem(False)
End Sub
...
Private Sub UsarItem(ByVal DCK As Boolean)
    ...
    If (Inventario.SelectedItem > 0) And (Inventario.SelectedItem < MAX_INVENTORY_SLOTS + 1) Then _
        Call WriteUseItem(Inventario.SelectedItem, DCK)
End Sub
...
Private Sub cmdLanzar_Click()
    If Not ModoCombate Then
        ...
        Exit Sub
    End If
    If Not MainTimer.Check(TimersIndex.CastAttack, False) Then 'Corto intervalo de Golpe-Magia
...
Private Sub picInv_DblClick()
    ...
    ' @@ Lo sacamos a esto, insisto, no funciona
    
    'Static lasti As Long, lastx As Long
    'If lastx = GetTickCount - lasti Then MsgBox "Tas chiteando"
    'lastx = GetTickCount - lasti
    'lasti = GetTickCount
...
#End If
    ...
    Select Case EstadoLogin
        ...
        Case E_MODO.RecuperarPass
            Call WriteRecuperarPass
