...
Begin VB.Form frmCustomKeys 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label1 
         AutoSize        =   -1  'True
         Caption         =   "Seguro de resucitación"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label1 
         AutoSize        =   -1  'True
         Caption         =   "Activar/Desactivar Sonidos"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
...
Private Sub lvButtons_H1_Click()
    ...
    For i = 1 To CustomKeys.Count
        If LenB(Text1(i).Text) = 0 Then
            Call MsgBox("Hay una o más teclas no válidas, por favor verifique.", vbCritical Or vbOKOnly Or vbApplicationModal Or vbDefaultButton1, "AOForever")
            Exit Sub
        End If
    Next i
