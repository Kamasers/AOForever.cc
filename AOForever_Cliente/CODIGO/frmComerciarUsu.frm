...
Call InvComUsu.DrawInv 'Initialize(DirectD3D8, frmComerciarUsu.picInvComercio, Inventario.MaxObjs)
                Call InvOfferComUsu(0).DrawInv '(DirectD3D8, frmComerciarUsu.picInvOfertaProp, INV_OFFER_SLOTS)
                Call InvOfferComUsu(1).DrawInv '(DirectD3D8, frmComerciarUsu.picInvOfertaOtro, INV_OFFER_SLOTS)
                Call InvOroComUsu(0).DrawInv '(DirectD3D8, frmComerciarUsu.picInvOroProp, INV_GOLD_SLOTS, , TilePixelWidth * 2, TilePixelHeight, TilePixelWidth / 2)
                Call InvOroComUsu(1).DrawInv '(DirectD3D8, frmComerciarUsu.picInvOroOfertaProp, INV_GOLD_SLOTS, , TilePixelWidth * 2, TilePixelHeight, TilePixelWidth / 2)
                Call InvOroComUsu(2).DrawInv '(DirectD3D8, frmComerciarUsu.picInvOroOfertaOtro, INV_GOLD_SLOTS, , TilePixelWidth * 2, TilePixelHeight, TilePixelWidth / 2)
